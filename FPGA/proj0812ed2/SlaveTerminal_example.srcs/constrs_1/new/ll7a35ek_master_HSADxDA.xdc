...
#AD9288 IOs
set_property PACKAGE_PIN D1 [get_ports {ad9288_a[7]}]
set_property PACKAGE_PIN E2 [get_ports {ad9288_a[6]}]
set_property PACKAGE_PIN E1 [get_ports {ad9288_a[5]}]
set_property PACKAGE_PIN F2 [get_ports {ad9288_a[4]}]
set_property PACKAGE_PIN G1 [get_ports {ad9288_a[3]}]
set_property PACKAGE_PIN G2 [get_ports {ad9288_a[2]}]
set_property PACKAGE_PIN H1 [get_ports {ad9288_a[1]}]
set_property PACKAGE_PIN H2 [get_ports {ad9288_a[0]}]
set_property PACKAGE_PIN L3 [get_ports {ad9288_b[0]}]
set_property PACKAGE_PIN L2 [get_ports {ad9288_b[1]}]
set_property PACKAGE_PIN K3 [get_ports {ad9288_b[2]}]
set_property PACKAGE_PIN K2 [get_ports {ad9288_b[3]}]
set_property PACKAGE_PIN K1 [get_ports {ad9288_b[4]}]
set_property PACKAGE_PIN J1 [get_ports {ad9288_b[5]}]
set_property PACKAGE_PIN J3 [get_ports {ad9288_b[6]}]
set_property PACKAGE_PIN H3 [get_ports {ad9288_b[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports ad9288_*]

#DAC5652A IOs
set_property PACKAGE_PIN R5 [get_ports {dac5652a_a[0]}]
set_property PACKAGE_PIN T5 [get_ports {dac5652a_a[1]}]
set_property PACKAGE_PIN T7 [get_ports {dac5652a_a[2]}]
set_property PACKAGE_PIN T8 [get_ports {dac5652a_a[3]}]
set_property PACKAGE_PIN T9 [get_ports {dac5652a_a[4]}]
set_property PACKAGE_PIN T10 [get_ports {dac5652a_a[5]}]
set_property PACKAGE_PIN R12 [get_ports {dac5652a_a[6]}]
set_property PACKAGE_PIN T12 [get_ports {dac5652a_a[7]}]
set_property PACKAGE_PIN R13 [get_ports {dac5652a_a[8]}]
set_property PACKAGE_PIN T13 [get_ports {dac5652a_a[9]}]
set_property PACKAGE_PIN R11 [get_ports {dac5652a_b[0]}]
set_property PACKAGE_PIN R10 [get_ports {dac5652a_b[1]}]
set_property PACKAGE_PIN P9 [get_ports {dac5652a_b[2]}]
set_property PACKAGE_PIN N9 [get_ports {dac5652a_b[3]}]
set_property PACKAGE_PIN R8 [get_ports {dac5652a_b[4]}]
set_property PACKAGE_PIN P8 [get_ports {dac5652a_b[5]}]
set_property PACKAGE_PIN R7 [get_ports {dac5652a_b[6]}]
set_property PACKAGE_PIN R6 [get_ports {dac5652a_b[7]}]
set_property PACKAGE_PIN N6 [get_ports {dac5652a_b[8]}]
set_property PACKAGE_PIN M6 [get_ports {dac5652a_b[9]}]
...
set_property PACKAGE_PIN C4 [get_ports MOSI]
set_property PACKAGE_PIN D4 [get_ports MISO]
set_property PACKAGE_PIN D5 [get_ports SCK]
set_property PACKAGE_PIN D6 [get_ports CS]
...
#set_property PACKAGE_PIN A3 [get_ports CS_ADS7883A];
#set_property PACKAGE_PIN B2 [get_ports DI_ADS7883A];
#set_property PACKAGE_PIN A2 [get_ports SCK_ADS7883A];
#set_property PACKAGE_PIN B1 [get_ports CS_ADS7883B];
#set_property PACKAGE_PIN C1 [get_ports DI_ADS7883B];
#set_property PACKAGE_PIN F3 [get_ports SCK_ADS7883B];
...
set_property PACKAGE_PIN N16 [get_ports GATE]
#set_property PACKAGE_PIN M16 [get_ports p402];  # p
#set_property PACKAGE_PIN K13 [get_ports p401];  # p
...
set_input_delay -clock [get_clocks sys_clk_pin] 5.000 [get_ports *ad9288*]
set_output_delay -clock [get_clocks sys_clk_pin] 5.000 dac5652a_b
